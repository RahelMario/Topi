        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#tambah">Tambah Menu </button>
                    <table class="table table-bordered mt-3">
                        ...
                        foreach ($menu as $mn) : ?>
                            <tr>
                                ...
                                <td><?= anchor('admin/Data_menu/edit/' . $mn->id, '<div class="btn btn-primary btn-sm">
                                    <i class="fa fa-edit"></i></div>') ?></td>
                                <td><?= anchor('admin/Data_menu/hapus/' . $mn->id, '<div class="btn btn-danger btn-sm">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="<?= base_url('admin/Data_menu/tambah_aksi'); ?>" method="post" enctype="multipart/form-data">
