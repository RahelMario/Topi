                    ...
                    <div class="row text-center  mt-3">
                        <?php foreach ($menu as $mn) : ?>
                            ...
                            <div class="card ml-4 mb-4" style="width: 18rem;">
                                <img src="<?= base_url('assets/img/') . $mn->gambar ?>" class="card-img-top" style="height: 15rem;" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title mb-3 "><?= $mn->nama_menu ?></h5>
                                    <small><?= $mn->des ?></small><br>
                                    <span class="badge badge-pill badge-success mb-3">Rp. <?= number_format($mn->harga, 0, ',', '.') ?></span><br>
                                    <?= anchor('user/order/' . $mn->id, '<div class="btn btn-sm btn-primary">Pesan</div>') ?>
                                    <?= anchor('user/detail/' . $mn->id, '<div class="btn btn-sm btn-success">Detail</div>') ?>
