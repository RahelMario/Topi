                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php foreach ($menu as $mn) : ?>
                                <div class="row">
                                    <div class="col-md-4">
                                        <img src="<?= base_url() . '/assets/img/' . $mn->gambar ?>" alt="">
                                    </div>
                                    <div class="col-md-8">
                                        <table class="table mt-3">
                                            <tr>
                                                <td>Nama Menu</td>
                                                <td><strong><?= $mn->nama_menu ?></strong></td>
                                            </tr>
                                            <tr>
                                                <td>Deskripsi</td>
                                            ...
                                            <tr>
                                                <td>Harga</td>
                                                <td> <strong>
                                                        <div class="btn btn-sm btn-success">Rp. <?= number_format($mn->harga, 0, ',', '.')  ?></div>
                                                    </strong></td>
                                            </tr>
                                        ...
                                        <?= anchor('user/menu/', '<div class="btn btn-sm btn-danger">Kembali</div>') ?>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
