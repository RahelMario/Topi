            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row text-center  mt-3">
                        <?php foreach ($minuman as $mnn) : ?>

                            <div class="card ml-4 mb-4" style="width: 18rem;">
                                <img src="<?= base_url('assets/img/') . $mnn->gambar ?>" class="card-img-top" style="height: 15rem;" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title mb-3 "><?= $mnn->nama_menu ?></h5>
                                    <small><?= $mnn->des ?></small><br>
                                    <span class="badge badge-pill badge-success mb-3">Rp. <?= number_format($mnn->harga, 0, ',', '.') ?></span><br>
                                    <?= anchor('user/order/' . $mnn->id, '<div class="btn btn-sm btn-primary">Pesan</div>') ?>
                                    <?= anchor('user/detail/' . $mnn->id, '<div class="btn btn-sm btn-success">Detail</div>') ?>
